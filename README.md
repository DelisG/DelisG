...
![React](https://img.shields.io/badge/React-D9794A?style=flat-square&logo=react&logoColor=F5EDE3)
![React Native](https://img.shields.io/badge/React_Native-D9794A?style=flat-square&logo=react&logoColor=F5EDE3)
...
| --- | --- | --- |
| [Cadastro de Alunos e Professores](https://github.com/Delisg/one) | Aplicação web com API REST de leitura | Python · Django · DRF · Docker |
| [Lista de Tarefas](https://github.com/Delisg/lista-de-tarefas) | Aplicação full stack com API REST e padrão MVC | Node.js · Express · MongoDB |
| [Cursos & Consultoria](https://github.com/Delisg/cursos-consultoria) | Site com rotas, tema claro/escuro e consulta de CEP | React · Context API · Bootstrap |
| [E-commerce App](https://github.com/Delisg/e-comerce) | App mobile com carrinho e nota fiscal em PDF | React Native · Expo |
| [Gestão Acadêmica](https://github.com/Delisg/gestao-academica) | CRUD de alunos | PHP · MySQL |
...
Hey there! I'm Delis Guerra, a full stack dev from Recife, Brazil, working with **Vue.js** on the front end and **C#, .NET and SQL** on the back end. Welcome to my GitHub, feel free to look around! ☕
